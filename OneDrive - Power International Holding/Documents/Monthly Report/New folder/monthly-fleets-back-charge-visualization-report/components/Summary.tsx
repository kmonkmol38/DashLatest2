            ...
            <div className="flex items-center gap-4">
                {activeReportKey === 'internal-fleets-category' && (
                  <div className="flex items-center gap-2">
                    ...
                    <select id="fc-filter" value={selectedFleetCategory} onChange={e => setSelectedFleetCategory(e.target.value)} className="bg-white border border-stone-300 rounded-md py-1 px-2 text-sm">
                        {internalFleetCategories.map(d => <option key={d} value={d}>{d}</option>)}
                    </select>
                  </div>
                )}
                {activeReportKey === 'internal-fleets-bu' && (
                  <div className="flex items-center gap-2">
                    ...
                    <select id="bu-filter-if" value={selectedBusinessUnit} onChange={e => setSelectedBusinessUnit(e.target.value)} className="bg-white border border-stone-300 rounded-md py-1 px-2 text-sm">
                        {internalFleetBUs.map(bu => <option key={bu} value={bu}>{bu}</option>)}
                    </select>
                  </div>
                )}
            </div>
            ...
            <div className="flex items-center gap-4">
                {activeReportKey === 'job-card-cluster' && (
                  <div className="flex items-center gap-2">
                    ...
                    <select id="cluster-filter" value={selectedCluster} onChange={e => setSelectedCluster(e.target.value)} className="bg-white border border-stone-300 rounded-md py-1 px-2 text-sm">
                        {jobCardClusters.map(d => <option key={d} value={d}>{d}</option>)}
                    </select>
                  </div>
                )}
                {activeReportKey === 'job-card-bu' && (
                  <div className="flex items-center gap-2">
                    ...
                    <select id="bu-filter-jc" value={selectedBusinessUnit} onChange={e => setSelectedBusinessUnit(e.target.value)} className="bg-white border border-stone-300 rounded-md py-1 px-2 text-sm">
                        {jobCardBUs.map(bu => <option key={bu} value={bu}>{bu}</option>)}
                    </select>
                  </div>
                )}
            </div>
          ...
          <div className="flex items-center gap-4">
            {activeReportKey === 'driver-operator-designation' && (
              <div className="flex items-center gap-2">
                ...
                <select id="designation-filter" value={selectedDesignation} onChange={e => setSelectedDesignation(e.target.value)} className="bg-white border border-stone-300 rounded-md py-1 px-2 text-sm">
                    {driverOpDesignations.map(d => <option key={d} value={d}>{d}</option>)}
                </select>
              </div>
            )}
            {activeReportKey === 'driver-operator-bu' && (
              <div className="flex items-center gap-2">
                ...
                <select id="bu-filter-do" value={selectedBusinessUnit} onChange={e => setSelectedBusinessUnit(e.target.value)} className="bg-white border border-stone-300 rounded-md py-1 px-2 text-sm">
                    {driverOpBUs.map(bu => <option key={bu} value={bu}>{bu}</option>)}
                </select>
              </div>
            )}
          </div>
