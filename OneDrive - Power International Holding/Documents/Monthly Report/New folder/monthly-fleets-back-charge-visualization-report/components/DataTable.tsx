...
const DataTable = forwardRef<HTMLDivElement, DataTableProps>(({ data, title, headers: explicitHeaders, actionButton, variant = 'dark', onRowDoubleClick }, ref) => {
        ...
        <table className="min-w-full">
          ...
          <tbody className={themeClasses.tbody}>
            {sortedData.map((row, i) => (
              ...
              >
                {headers.map(header => (
                  <td key={header} className={themeClasses.td}>
