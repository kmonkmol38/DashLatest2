                ...
                <div className="w-full bg-secondary p-2 rounded-lg flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="bg-primary border border-gray-600 rounded-md py-1 px-3 text-white focus:outline-none focus:ring-1 focus:ring-accent"
                        >
                            {dynamicBusinessUnits.map(bu => <option key={bu} value={bu}>{bu}</option>)}
                        </select>
                    </div>
