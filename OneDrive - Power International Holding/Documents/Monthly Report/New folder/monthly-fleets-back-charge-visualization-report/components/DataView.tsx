        ...
        <div className="flex items-stretch bg-secondary/20">
          ...
          <div className="bg-secondary flex flex-col justify-center p-2 ml-px flex-grow">
              ...
              <select
                ...
                className="bg-white text-black rounded-sm p-1 text-sm border-0 focus:ring-0 w-full"
              >
              {dynamicOptions.suppliers.map(unit => <option key={unit} value={unit}>{unit}</option>)}
              </select>
          </div>
            ...
            <div className="relative">
                ...
                {isServiceDropdownOpen && (
                    <div className="absolute top-full left-0 mt-1 w-full bg-secondary border border-gray-600 rounded-md shadow-lg z-20 max-h-60 overflow-y-auto">
                        {dynamicOptions.typesOfService.length > 0 ? dynamicOptions.typesOfService.map(service => (
                        ...
                        )) : <div className="p-2 text-sm text-gray-400">No options available</div>}
                    </div>
                )}
            </div>
          </div>
          ...
          <div className="bg-secondary flex flex-col justify-center p-2 ml-px flex-grow">
              ...
              <select
                ...
                className="bg-white text-black rounded-sm p-1 text-sm border-0 focus:ring-0 w-full"
              >
              {dynamicOptions.businessUnits.map(unit => <option key={unit} value={unit}>{unit}</option>)}
              </select>
          </div>
        </div>
      </div>
